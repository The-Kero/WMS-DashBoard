...
wb = load_workbook(r'C:\Users\JWPark\Desktop\냉장 재고조사\251205 냉장 재고조사(신선식품).xlsx')
ws = wb.active

print('='*60)
print('기존 파일 분석: 251205 냉장 재고조사(신선식품).xlsx')
print('='*60)
...
for col in ['A','B','C','D','E','F','G','H']:
    ...
    if c.fill.patternType:
        print(f'     fill: pattern={c.fill.patternType}, theme={c.fill.fgColor.theme}, tint={c.fill.fgColor.tint:.4f}')
    else:
        print(f'     fill: None')
