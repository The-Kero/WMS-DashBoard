...
├── Layout\                           ← 새로 생성! (레이아웃 작업 전용)
│   └── ourhome_layout_v2.html        ← 최신 프로토타입 (455줄)
├── ourhome.pcapng                    (10.5MB)
├── ourhome_page.html                 (3097줄, 112KB)
├── ourhome webpage.png               ← 사용자 제공 스크린샷
├── ourhome_layout_prototype.html     (467줄, 구버전)
├── PROJECT_DIARY.md                  (2200+줄)
├── PROJECT_CHECK_GUIDE.md
├── NEXT_CHAT_GUIDE_TVUI.md
└── TV_UI_TECHNICAL_DOC.md
```
...
### 프로젝트 체크 규칙
1. **대화 시작 시 필수:**
   - PROJECT_CHECK_GUIDE.md 먼저 읽기
   - PROJECT_DIARY.md 끝부분 읽기 (offset=-100)
   - 이 파일(NEXT_CHAT_GUIDE_LAYOUT.md) 읽기

2. **파일 위치:**
   - 레이아웃 작업: `C:\Projects\WMS-DashBoard\Layout\`
   - 문서: `C:\Projects\WMS-DashBoard\docs\`
   - 메인 프로젝트: `C:\Projects\WMS-DashBoard\`

3. **작업 기록:**
   - PROJECT_DIARY.md에 시간 단위 기록
   - 간단명료하게 작성
   - 시스템 시간 (분 단위) 포함
...
- [ ] PROJECT_CHECK_GUIDE.md 읽음
- [ ] PROJECT_DIARY.md 끝부분 읽음 (offset=-100)
- [ ] 이 파일(NEXT_CHAT_GUIDE_LAYOUT.md) 읽음
- [ ] Layout 폴더 확인
