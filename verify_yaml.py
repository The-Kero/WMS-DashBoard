"""
YAML 검증 스크립트
irregular_order 섹션의 컬럼 구성이 올바른지 확인
"""
import yaml
import sys
...
def verify_yaml():
    ...
    try:
        ...
        # irregular_order 섹션 찾기
        irregular = None
        for source in config['sources']:
            if source['name'] == 'irregular_order':
                irregular = source
                break
        
        if not irregular:
            print("[ERROR] irregular_order 섹션을 찾을 수 없습니다")
            return False
        
        print("[OK] irregular_order 섹션 발견")
        ...
        # 실제 컬럼
        actual = irregular['required_columns']
